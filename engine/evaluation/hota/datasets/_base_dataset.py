...
class _BaseDataset(ABC):
    ...
    def _calculate_box_ious(bboxes1, bboxes2, box_format='xywh', do_ioa=False):
        ...
        if box_format in 'xywh':
            ...
            # if bboxes1.shape[0] > 0 and bboxes2.shape[0] > 0:
            #   print( 'before' )
            #   print( 'bbox1', bboxes1 )
            #   print( 'bbox2', bboxes2 )
            ...
            #   print( 'bbox1', bboxes1 )
            #   print( 'bbox2', bboxes2 )
        elif box_format in 'tlwh':
          # layout (y0,x0,w,h)
          bboxes1 = deepcopy(bboxes1)
          bboxes2 = deepcopy(bboxes2)
          x01 = deepcopy( bboxes1[:,1] )
          y01 = deepcopy( bboxes1[:,0] )
          x02 = deepcopy( bboxes2[:,1] )
          y02 = deepcopy( bboxes2[:,0] )
          bboxes1[:,0] = x01
          bboxes1[:,1] = y01
          bboxes2[:,0] = x02
          bboxes2[:,1] = y02
