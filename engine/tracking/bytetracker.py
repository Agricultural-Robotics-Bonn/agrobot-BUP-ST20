...
class STrack(BaseTrack):
    ...
    def __init__(self, tlwh, score):
        ...
        self.num_delta_samples = 5 # Majik number currently.
        self.pos_x, self.pos_y = [tlwh[0],tlwh[2]+tlwh[0]], [tlwh[1],tlwh[3]+tlwh[1]]
    ...
    def re_activate(self, new_track, frame_id, new_id=False):
        ...
        self.pos_x.insert( 0, new_track.tlwh[0] )
        self.pos_y.insert( 0, new_track.tlwh[1] )
        if len( self.pos_x ) > self.num_delta_samples:
          self.pos_x.pop()
          self.pos_y.pop()
...
class Dynamic_BYTETracker(object):
    def __init__(self, args, criterion, frame_rate=30):
        ...
        self.det_thresh = args.det_thresh #args.track_thresh + 0.1
